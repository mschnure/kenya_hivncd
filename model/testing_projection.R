...
# DHS data Tables 13.12.1 & 13.12.2
...
# use this to get older age brackets; expit back to value

# pass intercept and slope as a sampled parameter; youngest age bracket will be its own 
