...
prior = join.distributions(
    ...
    trates = make.joint.distribution(median.r2 = 0.25,
                                     ...
                                     median.r3.to.r2 = 1,
                                     sd.r3.to.r2 = log(2)/2,
                                     median.r4.to.r3 = 1.25, # change to 1.25 for v25 
                                     sd.r4.to.r3 = log(2)/2), # change to log(2)/2 for v25
    ...
    proportion.trate.change.by.3.5 = Beta.Distribution(alpha = 15,beta = 5),
