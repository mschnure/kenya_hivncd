...
lose.suppression.unit.05 = create.intervention.unit(parameter = "UNSUPPRESSION.RATES",
                                                   scale = "proportion",
                                                   start.time = 2025,
                                                   effect.time = 2030,
                                                   effect.value = .05,
...
disengagement.unsuppressed.unit.15 = create.intervention.unit(parameter = "UNSUPPRESSED.DISENGAGEMENT.RATES",
                                                              scale = "proportion",
                                                              start.time = 2025,
                                                              effect.time = 2030,
                                                              effect.value = .15,
...
disengagement.suppressed.unit.15 = create.intervention.unit(parameter = "SUPPRESSED.DISENGAGEMENT.RATES",
                                                            scale = "proportion",
                                                            start.time = 2025,
                                                            effect.time = 2030,
                                                            effect.value = .15,
...
lose.suppression.05 = create.intervention.from.units(lose.suppression.unit.05,
                                                     code="lose.suppression.05")

disengagement.unsuppressed.15 = create.intervention.from.units(disengagement.unsuppressed.unit.15,
                                                              code="disengagement.unsuppressed.15")
...
disengagement.suppressed.15 = create.intervention.from.units(disengagement.suppressed.unit.15,
                                                            code="disengagement.suppressed.15")
...
all.intermediate = create.intervention.from.units(testing.unit.50,
                                                  ...
                                                  disengagement.unsuppressed.unit.15,
                                                  disengagement.suppressed.unit.15,
